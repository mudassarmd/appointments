...
$lang['about_app_info'] = 'Easy!Appointments is a highly customizable web application that allows your Students to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other Subjects.';
