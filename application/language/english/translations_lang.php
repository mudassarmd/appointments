...
$lang['payment_confirmation'] = "Payment";
$lang['service_and_provider'] = 'Select Subject and Teacher';
...
$lang['appointment_email_link_message'] = 'The Appointment link will be shared with you via Email.';
...
$lang['service'] = 'Subjects';
$lang['provider'] = 'Teachers';
...
$lang['manage_appointment_record_hint'] = 'Manage all the appointment records of the available Teachers and Subjects.';
$lang['select_filter_item_hint'] = 'Select a Teacher or a Subject and view the appointments on the calendar.';
...
$lang['manage_users_hint'] = 'Manage the backend users (admins, Teachers, secretaries).';
...
$lang['about_app'] = 'About FLS Academy';
...
$lang['book_advance_timeout_hint'] = 'Define the timeout (in minutes) before the Students can book or re-arrange appointments with the FLS Academy Teacher.';
$lang['timeout_minutes'] = 'Timeout (Minutes)';
$lang['about_app_info'] = 'FLS Academy is a highly customizable web application that allows your Students to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other Subjects.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using FLS Academy you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = 'FLS Academy is licensed under the GPLv3 license. By using the code of FLS Academy in any way you are agreeing to the terms described in the following url:';
...
$lang['backend_section'] = 'Login to FLS Academy Portal';
$lang['you_need_to_login'] = 'Please Login to continue';
...
$lang['ea_update_success'] = 'FLS Academy has been successfully updated.';
...
$lang['require_phone_number_hint'] = 'When enabled, Students and users will need to enter the Student\'s phone number when booking an appointment';
$lang['check_spam_folder'] = 'Please check your spam folder if the email does not arrive within a few minutes.';
$lang['api_token_hint'] = 'Set a secret token in order to enable the token based authentication of the FLS Academy API.';
$lang['timezone'] = 'Timezone';
$lang['overwrite_existing_working_plans'] = 'This will overwrite the existing Teacher working plans, are you sure that you want to continue?';
$lang['working_plans_got_updated'] = 'All the working plans got updated.';
$lang['apply_to_all_providers'] = 'Apply To All Teachers';
$lang['display_any_provider'] = 'Display Any Teacher Option';
$lang['display_any_provider_hint'] = 'The booking page will get an additional option that allows Students to book without specifying a Teacher.';
